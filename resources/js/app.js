...
if (window.axios) {
    ...
    window.axios.defaults.headers.common['Access-Control-Allow-Headers'] = 'Content-Type, Authorization, X-Requested-With, X-CSRF-TOKEN';
...
if (window.Echo) {
    ...
    window.Echo.connector.pusher.config.disabledTransports = ['xhr_polling', 'xhr_streaming'];
}
